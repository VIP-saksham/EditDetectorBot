...
<p align="center">
  <a href="https://dashboard.heroku.com/new?template=https://github.com/teamrdxnetwork">
...
# Clone repo
git clone https://github.com/VIP-saksham/EditDetectorBot
cd Sam
...
ExecStart=/opt/Sam/venv/bin/python /opt/Sam/main.py
Restart=always
RestartSec=5
