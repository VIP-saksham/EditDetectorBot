...
PM_START_TEXT = """
*Hello* {}[✨]({}) 👋 I'm your 𝗘𝗱𝗶𝘁 𝗗𝗲𝘁𝗲𝗰𝘁𝗼𝗿 𝗕𝗼𝘁, here to maintain a secure environment for our discussions.
...
buttons = [
    [
        InlineKeyboardButton(
            ...
            url=f"https://t.me/EditDetectorBot?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(text="𝗦𝘂𝗽𝗽𝗼𝗿𝘁", url=f"https://t.me/Team_RDX_POINT"),
        InlineKeyboardButton(text="𝗦𝗼𝘂𝗿𝗰𝗲", url=f"https://github.com/TeamRDXnetwork"),
    ],    
    [
        InlineKeyboardButton(text="𝗢𝘄𝗻𝗲𝗿", url=f"https://t.me/inakshu"),
    ],
